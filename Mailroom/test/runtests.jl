...
# !!! Main.UserApp is configured as an alias for Main.Mailroom and you might encounter it in some tests
using Main.Mailroom, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Mailroom tests" begin
  @includetests ARGS
end
